...
#    Updated: 2023/08/30 18:06:53 by ndahib           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# CFLAGS =
NAME = cub3D
SRCS = main.c checks.c mlx_hook.c render_map.c initilize.c tools.c rays.c walls.c checking_map2.c checking_map3.c check_2.c check_rgb.c direction.c keys.c casting.c
OBJS = $(SRCS:.c=.o)
